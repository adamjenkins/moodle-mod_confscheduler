...
/**
 * AJAX-only external function that unschedules a slot (removes it from the
 * grid, returning any presentation to the "unscheduled" panel).
 *
 * @package    mod_confscheduler
 * @copyright  2026 Adam Jenkins <adam@wisecat.net>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class unschedule_slot extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'slotid' => new external_value(PARAM_INT, 'The confscheduler_slot id to unschedule'),
        ]);
    }
     ...
     * @param int $slotid The confscheduler_slot id to unschedule
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'success' => new external_value(PARAM_BOOL, 'Whether the unschedule succeeded'),
        ]);
    }
}
