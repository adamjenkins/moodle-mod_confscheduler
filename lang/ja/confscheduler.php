...
$string['blockwithdrawn'] = 'この発表は応募者によって取り下げられたため、開催されません。';
$string['childtextalign'] = 'テキストの配置（水平）';
$string['childtextalign:center'] = '中央';
$string['childtextalign:left'] = '左';
$string['childtextalign:right'] = '右';
$string['childtextvalign'] = 'テキストの配置（垂直）';
$string['childtextvalign:bottom'] = '下';
$string['childtextvalign:middle'] = '中央';
$string['childtextvalign:top'] = '上';
$string['colour'] = 'カラー';
...
$string['confirmdeletecontainer'] = 'このコンテナーを削除しますか？ 内部にネストされた {$a} 件の発表もすべて未配置に戻ります。元に戻すことはできません。';
...
$string['dateview_all'] = 'すべての日';
$string['dateview_closest'] = '直近の日';
$string['day'] = '日程';
$string['daybounds_automatic'] = '自動';
$string['dayboundsscope'] = '適用対象';
$string['dayend'] = '表示終了時刻';
$string['dayend_help'] = 'スケジュールグリッドが表示する最も遅い時刻です。日程セレクターで表示している日に適用されます。特定の日を選べばその日の終了時刻を、「すべての日」を選べば個別設定のない日すべてに使われる既定値を設定できます(開催日ごとに終了時刻が異なることはよくあります)。表示範囲外にスケジュールされた発表も全体が表示され(グリッドがそれを含むように広がります)、範囲外の部分は「会議時間外」の帯と同様にグレー表示されます。';
$string['daystart'] = '表示開始時刻';
$string['daystart_help'] = 'スケジュールグリッドが表示する最も早い時刻です。日程セレクターで表示している日に適用されます。特定の日を選べばその日の開始時刻を、「すべての日」を選べば個別設定のない日すべてに使われる既定値を設定できます。「自動」のままにすると、その日は実際にスケジュールされている内容から表示範囲が決まります(特定の日では、「自動」は「すべての日」の既定値を継承することを意味します)。';
$string['defaultdateview'] = '既定の表示日';
$string['defaultdateview_help'] = '初めての閲覧者（または下の「各ユーザーの最後に表示した日を記憶する」による記憶がない閲覧者）に対して、スケジュール表示が最初にどの日を表示するかです。「直近の日」は今日に最も近い日を、「すべての日」はすべての日をまとめて表示します。';
$string['deletecontainer'] = 'コンテナーを削除';
$string['deleteroom'] = '会場を削除';
$string['dismiss'] = '破棄';
$string['dismissed'] = '破棄しました。';
$string['displaysettings'] = '表示設定';
$string['editroom'] = '会場を編集';
$string['editspanblock'] = 'スパンブロックを編集';
$string['error:alreadyscheduled'] = 'この応募はすでにこのインスタンス内の別の場所に配置されています。';
$string['error:cannotreschedulechild'] = 'コンテナセッション内に配置された発表は単独では移動できません（コンテナと一緒に移動します）。先にコンテナから取り出してください。';
...
$string['error:invaliddayvalue'] = '認識できない日付です。';
...
$string['error:invalidtextalign'] = 'テキストの水平方向の配置は left、center、right のいずれかを指定してください。';
$string['error:invalidtextvalign'] = 'テキストの垂直方向の配置は top、middle、bottom のいずれかを指定してください。';
...
$string['error:notacontainer'] = 'この操作はコンテナースパンブロックにのみ適用されます。';
...
$string['hour'] = '時';
$string['iscontainer'] = 'コンテナー（発表のネストを許可）';
...
$string['nopendingnotifications'] = '保留中の通知はありません。';
$string['notifbody'] = '本文';
...
$string['pendingnotifications'] = '保留中の通知 ({$a})';
$string['pendingnotificationsheading'] = '保留中の通知';
$string['pluginadministration'] = 'Conference Scheduler の管理';
$string['pluginname'] = 'Conference Scheduler';
$string['presentationwithdrawn'] = '発表が取り下げられました';
$string['print'] = '印刷';
$string['privacy:metadata'] = 'Conference Scheduler プラグイン自身のテーブルには会場・列の設定と配置済みの時間ブロックのデータのみが保存されます（いずれもプラグイン間参照の応募IDまたは単なるテキストラベルを参照するのみで、ユーザーそのものは参照しません）。また、切り替え対象となる「my timetable」のお気に入り状態は、すべて Conference Program プラグイン側で保存されます。本プラグインが保存する唯一の個人データは、各ユーザーがスケジュールで最後に表示した日を記憶するユーザープリファレンスです。';
$string['privacy:metadata:preference:lastday'] = 'スケジュールの日選択で最後に表示した会議日。次回同じ日から表示を再開するために記憶されます。';
...
$string['rememberlastday'] = '各ユーザーの最後に表示した日を記憶する';
$string['rememberlastday_help'] = '有効にすると、再訪した閲覧者には上の「既定の表示日」ではなく、前回自分が選んだ日（または「すべての日」）が表示されます。デバイス単位ではなく、ユーザー単位で記憶されます。';
...
$string['roomname'] = '会場名';
$string['roomnameoverride'] = '表示する会場名（任意）';
