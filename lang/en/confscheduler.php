...
$string['blockwithdrawn'] = 'This presentation has been withdrawn by its submitter and will not take place.';
$string['childtextalign'] = 'Text alignment (horizontal)';
$string['childtextalign:center'] = 'Center';
$string['childtextalign:left'] = 'Left';
$string['childtextalign:right'] = 'Right';
$string['childtextvalign'] = 'Text alignment (vertical)';
$string['childtextvalign:bottom'] = 'Bottom';
$string['childtextvalign:middle'] = 'Middle';
$string['childtextvalign:top'] = 'Top';
...
$string['confirmdeletecontainer'] = 'Delete this container? This will also unschedule the {$a} presentation(s) nested inside it. This cannot be undone.';
...
$string['dateview_all'] = 'All days';
$string['dateview_closest'] = 'Closest day';
$string['day'] = 'Day';
$string['daybounds_automatic'] = 'Automatic';
$string['dayboundsscope'] = 'Applies to';
$string['dayend'] = 'Day end';
$string['dayend_help'] = 'The latest time of day the schedule grid displays. It applies to whichever day the day selector is showing: pick a specific day to set that day\'s end time, or "All days" to set the default used by every day without its own setting (conference days often finish at different times). A presentation scheduled outside the day start/end window is still shown in full -- the grid widens just enough to include it -- but the area outside the window is greyed out, the same as the out-of-conference-hours band.';
$string['daystart'] = 'Day start';
$string['daystart_help'] = 'The earliest time of day the schedule grid displays. It applies to whichever day the day selector is showing: pick a specific day to set that day\'s start time, or "All days" to set the default used by every day without its own setting. Leave Automatic checked to size that day from whatever is actually scheduled (for a specific day, Automatic means it inherits the "All days" default).';
$string['defaultdateview'] = 'Default day view';
$string['defaultdateview_help'] = 'Which day the schedule display starts on for a first-time viewer (or any viewer without a remembered day -- see "Remember each user\'s last viewed day" below): "Closest day" shows the day nearest today, "All days" shows every day at once.';
...
$string['error:alreadyscheduled'] = 'This submission is already scheduled elsewhere in this instance.';
$string['error:cannotreschedulechild'] = 'A presentation nested inside a container session cannot be moved on its own -- it moves with its container. Remove it from the container first.';
...
$string['error:invaliddayvalue'] = 'That is not a recognised day.';
...
$string['error:invalidtextalign'] = 'Text alignment must be left, center, or right.';
$string['error:invalidtextvalign'] = 'Text alignment must be top, middle, or bottom.';
...
$string['error:notacontainer'] = 'This operation only applies to a container span block.';
...
$string['hour'] = 'Hour';
$string['iscontainer'] = 'Container (allow nested presentations)';
...
$string['presentationwithdrawn'] = 'Presentation withdrawn';
$string['print'] = 'Print';
$string['privacy:metadata'] = 'The Conference Scheduler plugin\'s own tables hold only room/column configuration and scheduled time-block data (each of which reference a cross-plugin submission id or a plain text label, never a user), and the "my timetable" favourite state it toggles is stored entirely by the Conference Program plugin. The only personal data it stores is a user preference remembering the last day each user viewed in the schedule.';
$string['privacy:metadata:preference:lastday'] = 'The last conference day you viewed in a scheduler\'s day selector, remembered so the schedule reopens on that day.';
...
$string['rememberlastday'] = 'Remember each user\'s last viewed day';
$string['rememberlastday_help'] = 'When enabled, a returning viewer sees whichever day (or "All days") they last selected here, instead of the "Default day view" above. Remembered per user, not per device.';
...
$string['roomnameoverride'] = 'Displayed room name (optional)';
