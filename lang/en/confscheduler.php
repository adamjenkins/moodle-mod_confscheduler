...
$string['autoschedulerdefaultduration'] = 'Default duration (minutes)';
$string['autoschedulerdefaultduration_help'] = 'Every submission the autoscheduler places is given this same duration; there is no per-submission duration in the underlying data.';
...
$string['displaymodenotbuiltyet'] = 'The read-only schedule display has not been built yet. This is a scaffold release.';
...
$string['error:sessiontagtoolong'] = 'The session label must be 255 characters or fewer.';
...
$string['privacy:metadata'] = 'The Conference Scheduler plugin does not store any personal data. Its tables hold only room/column configuration, scheduled time-block data, and session-grouping labels (each of which reference a cross-plugin submission id or a plain text label, never a user), and the "my timetable" favourite state it toggles is stored entirely by the Conference Program plugin.';
$string['roomcolour'] = 'Colour theme';
$string['roomname'] = 'Room name';
$string['schedulingsettings'] = 'Scheduling settings';
$string['sessiontag'] = 'Session';
$string['sessiontag_help'] = 'An optional label used to group presentations into the same "session". The autoscheduler tries to place all submissions sharing the same session label consecutively, in the same room. This label is local to this Conference Scheduler instance and is not shared with the Conference Program or Conference Submissions activities.';
$string['sessiontagplaceholder'] = 'No session';
